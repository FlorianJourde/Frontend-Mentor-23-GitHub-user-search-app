...
export default function Search(props: any) {
  ...
  return (
    <form className={'bg-card-background p-3 rounded-2xl flex flex-wrap justify-center items-center gap-4 shadow-primary transition-colors  ' + searchError} onSubmit={handleSubmit}>
      ...
      <input className='bg-button-background w-full sm:w-[unset] text-button-text font-bold rounded-lg px-6 py-4 cursor-pointer hover:opacity-75 transition-opacity' type="submit" value="Search" onSubmit={handleSubmit} />
    </form>
  )
}
